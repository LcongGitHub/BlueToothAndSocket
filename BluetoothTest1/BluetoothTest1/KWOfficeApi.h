...
#pragma mark - 只使用企业版 WPS 打开文件请使用此方法，并设置 enterpriseOnly 属性为 YES
- (BOOL)sendFileData:(NSData *)data withFileName:(NSString *)fileName callback:(NSString *)callback delegate:(id)delegate policy:(NSDictionary *)rightsDict error:(NSError **)errPtr enterpriseOnly:(BOOL)enterpriseOnly;
